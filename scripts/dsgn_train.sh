...
DATA_PATH="${DATA_PATH:-${ROOT}/dsgn/datasets/arka/dsgn_awsim/training}"
SPLIT_FILE="${SPLIT_FILE:-${ROOT}/dsgn/datasets/arka/dsgn_awsim/trainval.txt}"
CFG="${CFG:-${DSGN}/configs/config_car_12g_awsim.py}"
LOADMODEL="${LOADMODEL:-${ROOT}/dsgn/checkpoints/kitti/dsgn_12g_b/finetune_48.tar}"
SAVEMODEL="${SAVEMODEL:-${ROOT}/dsgn/checkpoints/adria/dsgn_12g_awsim}"
EPOCHS="${EPOCHS:-60}"
BTRAIN="${BTRAIN:-1}"
GPU="${GPU:-0}"
...
ln -sfn "${ROOT}/dsgn/datasets/arka/dsgn_awsim/trainval.txt" "${DSGN}/data/awsim/trainval.txt"
ln -sfn "${ROOT}/dsgn/datasets/arka/dsgn_awsim/train.txt" "${DSGN}/data/awsim/train.txt"
ln -sfn "${ROOT}/dsgn/datasets/arka/dsgn_awsim/val.txt" "${DSGN}/data/awsim/val.txt"
ln -sfn "${ROOT}/dsgn/datasets/arka/dsgn_awsim/test.txt" "${DSGN}/data/awsim/test.txt"
ln -sfn "${ROOT}/dsgn/datasets/arka/dsgn_awsim/testing" "${DSGN}/data/awsim/testing"
